#  Ejercicios vistas consultas en SQL - Tabla `users`
...
## Ejercicio 3 – Vista de contactos consolidados
...
## Ejercicio 4 – Vista de perfil ejecutivo
...
- incluya
    ...
    - `education_level`
    - `company`
- incluya informacion financiera:
    - `monthly_income`
