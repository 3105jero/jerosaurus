# Taller de consulas SQL por niveles
## nivel 1
...
2. Obtener todos los pedidos (código y fecha) realizados por un usuario con un correo electrónico específico (ej: `Sebastian@elmejor.es`).
...
## Nivel 3 Consultas Complejas y Reportes
...
```
## Nivel 4: Logica de Negocio y Analitica Avanzada
